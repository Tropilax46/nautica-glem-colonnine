  ...
  return (
    <div className="min-h-screen flex">
      <aside className="w-60 bg-glem-700 text-white p-6 flex flex-col">
        ...
        <div className="text-xs text-glem-50 opacity-70 mb-8">Pannello operatore</div>
            ...
            return (
              <Link
                ...
                className={`block px-3 py-2 rounded ${
                  active ? "bg-glem-500" : "hover:bg-glem-500/40"
                }`}
              >
                {n.label}
              </Link>
        ...
        <button onClick={logout} className="mt-6 text-sm opacity-80 hover:opacity-100 text-left">
          Esci
        </button>
      </aside>
